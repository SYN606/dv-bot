...
class AFK(Model, TimestampMixin):
    ...
    def __repr__(self) -> str:
        return f"<AFK guild_id={self.guild_id} user_id={self.user_id}>"
...
class VCRoleConfig(Model, TimestampMixin):
    guild = fields.OneToOneField("models.Guild",
                                 pk=True,
...
class TempbanRecord(Model, TimestampMixin):
    ...
    user = fields.ForeignKeyField("models.User",
                                  ...
                                  on_delete=fields.CASCADE)
    moderator = fields.ForeignKeyField("models.User",
...
class AutoResponderReaction(Model):
    id = fields.IntField(pk=True)
    responder = fields.ForeignKeyField("models.AutoResponder",
