                  ...
                  <div className="pt-2">
                    {isBotPresent ? (
                      ...
                      <a
                        ...
                        className="w-full inline-flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl text-xs font-semibold bg-white/10 hover:bg-white/15 text-slate-200 border border-white/10 transition-all hover:border-indigo-500/40"
                      >
