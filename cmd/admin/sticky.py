...
class Sticky(
    ...
    @app_commands.describe(
        channel="Channel where sticky should be disabled",
    )
        ...
        await interaction.followup.send(
            embed=make_embed(
                ...
                description=(
                    ...
                    if removed
                    else f"{EMOJIS['warning']} No sticky configured."
                ),
    ...
    @app_commands.describe(
        channel="Channel to check sticky status",
    )
        ...
        await interaction.followup.send(
            embed=make_embed(
                ...
                description=(
                    ...
                    if content
                    else f"{EMOJIS['red_dot']} Sticky not enabled in {channel.mention}."
                ),
                level="INFO",
            ),
            ephemeral=True,
