...
async def _member_is_bot_admin(member: discord.Member, ) -> bool:
    """
    Hardened bot-admin resolver.

    ALLOWED:
    - Guild Owner
    - Administrator Permission
    - Explicit DB Bot-Admin Roles
...
async def is_bot_admin(interaction: discord.Interaction, ) -> bool:
    ...
    if (member is None and isinstance(
            user,
            discord.Member,
    )):
        member = user
