...
class CommandControlView(discord.ui.View):
    ...
    async def status(
        ...
        disabled = get_disabled_commands(self.guild.id)
...
class CommandSelect(discord.ui.Select):
    ...
    async def callback(self, interaction: discord.Interaction):
        ...
        if self.view_ref.mode == "disable":
            changed = disable_command(self.view_ref.guild.id, command_name)
            msg = (
            ...
            changed = enable_command(self.view_ref.guild.id, command_name)
