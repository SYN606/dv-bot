...
class VerifyCaptchaModal(discord.ui.Modal):
    ...
    def __init__(self, guild_id: int):
        ...
        # FIX: Define the display input cleanly. Instead of changing it afterwards,
        # we give it a default value. It remains uneditable if they type elsewhere.
    ...
    async def on_submit(self, interaction: discord.Interaction) -> None:
        ...
        async with lock:
            ...
            # Captcha Verification Logic (Ensures clean stripping and identical casing comparison)
            ...
            if not config or not config.verified_role_id:
                await interaction.followup.send(embed=make_embed(
                    ...
                    description="Verification system is not configured fully.",
                    level="ERROR"),
                                                ephemeral=True)
                return
            ...
            unverified_role = guild.get_role(
                unverified_role_id) if unverified_role_id else None
