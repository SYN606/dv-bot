...
class ModNotifier:
    ...
    # KICK
    @staticmethod
    async def notify_kick(member: discord.Member, guild_name: str,
                          moderator: discord.Member, reason: str) -> bool:
    ...
    # BAN
    @staticmethod
    async def notify_ban(member: discord.Member, guild_name: str,
                         moderator: discord.Member, reason: str) -> bool:
    ...
    # TIMEOUT
    @staticmethod
    async def notify_timeout(member: discord.Member, guild_name: str,
                             moderator: discord.Member, duration: str,
                             reason: str) -> bool:
